...
git clone https://github.com/hyperpolymath/sinople-journal-theme.git cd
...
toolbox create sinople-journal-theme-dev toolbox enter
sinople-journal-theme-dev # Install dependencies manually
...
sinople-journal-theme/ ├── src/ # Source code (Perimeter 1-2) ├── lib/ #
