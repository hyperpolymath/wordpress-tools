...
### P6: Replace innerHTML with -dom-mounter (CRITICAL)
...
**-dom-mounter** (`hyperpolymath/-dom-mounter`) which provides:
...
**Action:** Add -dom-mounter as a dependency. Rewrite graph-viewer.js
and navigation.js in  using SafeDOM.mountStringParsed. Remove all raw
