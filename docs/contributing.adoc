...
= Contributing — wordpress-tools
:revdate: 2026-MM-DD

== Audience

Developers working *on* `wordpress-tools`. For consumers (people calling
...
[source,bash]
----
git clone git@github.com:hyperpolymath/wordpress-tools.git
cd wordpress-tools
...
* Bugs in `wordpress-tools`: file at `hyperpolymath/wordpress-tools/issues`.
