...
// Replace wordpress-tools, Wordpress Tools — See README.adoc for details., just run, Wordpress Tools started successfully. with actuals
= wordpress-tools — Quick Start for Users
:toc:
:toclevels: 2

== What is wordpress-tools?

Wordpress Tools — See README.adoc for details.
...
[source,bash]
----
just install --portable --prefix=./wordpress-tools-portable
----
...
[source]
----
Wordpress Tools started successfully.
----
...
* **Wiki**: https://github.com/hyperpolymath/wordpress-tools/wiki
