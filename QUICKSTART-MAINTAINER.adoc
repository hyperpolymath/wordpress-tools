...
// Replace wordpress-tools, {{PACKAGE_NAME}}, {{DEPS}} with actuals
= wordpress-tools — Quick Start for Platform Maintainers
:toc:
:toclevels: 2

== Overview

This guide covers packaging, deploying, and maintaining wordpress-tools for
...
podman build -t wordpress-tools .
----
...
* Upstream: https://github.com/hyperpolymath/wordpress-tools/issues
