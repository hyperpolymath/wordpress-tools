...
git clone https://github.com/hyperpolymath/wordpress-tools.git cd
wordpress-tools
...
toolbox create wordpress-tools-dev toolbox enter wordpress-tools-dev #
...
wordpress-tools/ ├── src/ # Source code (Perimeter 1-2) ├── lib/ #
