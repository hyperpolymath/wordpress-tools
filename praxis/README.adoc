...
[![License: PMPL 1.0]()](https://github.com/hyperpolymath/palimpsest-license)
...
- *🌐 True Polyglot* - 8 languages working together (Rust, Elixir, , PHP, PowerShell, LFE, Racket, SQL)
...
| *Swarm System* | /Bun | Distributed execution coordinator |
...
| *GraphQL API* |  | Unified API layer with subscriptions |
| *Dashboard* | /HTML | Real-time monitoring and control |
...
cd SymbolicEngine/swarm && bun test         #  tests
```
...
- ✅ Type safety (Rust,  strict mode, Elixir specs)
...
WP Praxis is free software: you can redistribute it and/or modify it under the terms of the PMPL as published by the Free Software Foundation, either version 3 of the License, or (at your option) any later version.
...
Built with:
- Rust, Elixir, /Bun, PHP, PowerShell, LFE, Racket
