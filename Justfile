...
doctor:
    @echo "Running diagnostics for wordpress-tools..."
...
help-me:
    @echo "=== wordpress-tools Help ==="
    @echo "Platform: $(uname -s) $(uname -m)"
    @echo "Shell: $SHELL"
    @echo ""
    @echo "To report an issue:"
    @echo "  https://github.com/hyperpolymath/wordpress-tools/issues/new"
    @echo ""
