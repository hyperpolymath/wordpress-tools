...
[arabic]
. Navigate to
https://github.com/hyperpolymath/wordpress-tools/security/advisories/new[Report
a Vulnerability]
...
https://github.com/hyperpolymath/wordpress-tools/security/advisories[Security
Advisories]
...
|*General questions*
|https://github.com/hyperpolymath/wordpress-tools/discussions[GitHub
Discussions]
...
_Thank you for helping keep Wordpress Tools and its users safe._ 🛡️
