...
=== Web Projects
 ...
 web projects in the hyperpolymath ecosystem **MUST** use these formally verified components:

[cols="1,2,1"]
|===
|Library |Purpose |Status

|link:https://github.com/hyperpolymath/-dom-mounter[-dom-mounter]
|Formally verified DOM mounting
|**REQUIRED**

|link:https://github.com/hyperpolymath/-tea[-tea]
...
✓ Type-safe operations ( + Idris2)
✓ Zero runtime overhead (proofs erased)

See link:https://github.com/hyperpolymath/-dom-mounter[-dom-mounter documentation] for full details.
