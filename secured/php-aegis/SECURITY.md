...
2. Report via [GitHub Security Advisories](https://github.com/hyperpolymath/php-aegis/security/advisories/new) (preferred)
3. Or contact the maintainer via [GitHub profile](https://github.com/hyperpolymath)
