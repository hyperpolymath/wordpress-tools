...
Replace all {{PLACEHOLDER}} values with your information:
  Wordpress Tools     - Your project name
  hyperpolymath            - GitHub username or org (e.g., hyperpolymath)
  wordpress-tools             - Repository name
...
1. Navigate to [Report a Vulnerability](https://github.com/hyperpolymath/wordpress-tools/security/advisories/new)
...
- This repository (`hyperpolymath/wordpress-tools`) and all its code
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/hyperpolymath/wordpress-tools/security/advisories)
...
When using Wordpress Tools, we recommend:
...
- [Security Advisories](https://github.com/hyperpolymath/wordpress-tools/security/advisories)
...
| Purpose | Contact |
|---------|---------|
| **Security issues** | [Report via GitHub](https://github.com/hyperpolymath/wordpress-tools/security/advisories/new) or 6759885+hyperpolymath@users.noreply.github.com |
| **General questions** | [GitHub Discussions](https://github.com/hyperpolymath/wordpress-tools/discussions) |
...
*Thank you for helping keep Wordpress Tools and its users safe.* 🛡️
